        ...
        <div className="flex flex-col items-center overflow-y-auto laptop:overflow-hidden bg-white h-full w-6/12 laptop:h-660px p-5" aria-hidden onClick={(e) => e.stopPropagation()}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-evenly w-full h-full laptop:h-auto laptop:mt-16 text-black px-2">
            ...
            <div className="flex items-center my-2">
              <input className="mr-2 cursor-pointer" onClick={() => checkBoxInputkHandler()} {...register('gotOffered')} type="checkbox" />
            ...
            <input disabled className="relative bottom-0 w-full bg-alto text-white py-2 text-base rounded-md cursor-pointer" type="submit" />
            <input className="relative bottom-0 w-full bg-primary text-white py-2 text-base rounded-md cursor-pointer" type="submit" />
          </form>
          <div>Or</div>
