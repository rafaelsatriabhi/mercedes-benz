...
const ModalForm = ({ setShowModal }) => {
  ...
  return (
    <div aria-hidden onClick={() => setShowModal(false)} className="fixed z-50 h-full w-full bg-black bg-opacity-50 flex justify-center">
      <div className="relative flex flex-col justify-evenly text-black h-full bg-blue-100 max-w-xl py-10 px-5">
        <svg className="absolute right-10 top-5" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="overflow-y-auto bg-white h-full p-5" aria-hidden onClick={(e) => e.stopPropagation()}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-evenly w-full h-full mt-16 text-black px-2">
