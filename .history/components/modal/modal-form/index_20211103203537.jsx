...
const ModalForm = ({ setShowModal }) => {
  ...
  return (
    <div aria-hidden onClick={() => setShowModal(false)} className="fixed z-50 h-full w-full bg-black bg-opacity-50 flex justify-center laptop:justify-start">
      <div className="relative flex flex-col justify-evenly text-black h-full bg-black bg-opacity-25 max-w-xl laptop:w-full">
