...
const ModalForm = ({ setShowModal }) => {
  ...
  return (
    <div aria-hidden onClick={() => setShowModal(false)} className="fixed z-50 h-full w-full bg-black bg-opacity-50 flex justify-center">
      <div className="relative flex flex-col lapptop:items-center justify-evenly text-black h-full bg-black bg-opacity-25 w-96 laptop:w-full">
        ...
        <div className="overflow-y-auto bg-white h-full w-6/12 laptop:h-660px p-5" aria-hidden onClick={(e) => e.stopPropagation()}>
