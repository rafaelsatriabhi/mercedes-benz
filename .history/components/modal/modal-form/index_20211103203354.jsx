...
const ModalForm = ({ setShowModal }) => {
  ...
  return (
    <div aria-hidden onClick={() => setShowModal(false)} className="fixed z-50 h-full w-full bg-black bg-opacity-50 flex justify-center">
      <div className="relative flex flex-col justify-evenly text-black h-full bg-black bg-opacity-25 max-w-xl laptop:">
        ...
        <div className="overflow-y-auto bg-white h-full laptop:h-96 p-5" aria-hidden onClick={(e) => e.stopPropagation()}>
