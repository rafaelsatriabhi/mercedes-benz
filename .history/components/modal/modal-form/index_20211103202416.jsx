...
const ModalForm = ({ setShowModal }) => {
  ...
  return (
    <div aria-hidden onClick={() => setShowModal(false)} className="fixed z-50 h-full w-full bg-black bg-opacity-50 flex justify-center pt-14">
      <div className="flex flex-col justify-evenly text-black h-full bg-blue-100 max-w-xl py-10">
        <div className="overflow-y-auto bg-white h-full py-5" aria-hidden onClick={(e) => e.stopPropagation()}>
