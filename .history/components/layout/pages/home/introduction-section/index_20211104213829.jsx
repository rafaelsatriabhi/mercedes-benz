  ...
  return (
    <>
      <section className="w-full 96" id="carousel-section">
        <div className="flex flex-col laptop:flex-row justify-center laptop:justify-between w-full laptop:w-10/12 h-full bg-gradient-to-t laptop:bg-gradient-to-r from-black">
