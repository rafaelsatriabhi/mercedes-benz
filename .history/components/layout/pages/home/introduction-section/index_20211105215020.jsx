      ...
      <section className="w-full 96" id="carousel-section">
        <div className="flex flex-col laptop:flex-row justify-center laptop:justify-between w-full h-full bg-gradient-to-t laptop:bg-gradient-to-r from-black">
          ...
          <div className="w-full laptop:w-5/12 px-3.5 flex flex-col items-center justify-center bottom-0 laptop:bottom-28">
            <div aria-hidden role="button" onClick={() => setShowModal(true)} className="bg-red-800 w-full py-4 mb-5 transition duration-500 ease-in-out bg-red-600 hover:bg-blue-600 transform hover:-translate-y-1 hover:scale-110">Berikan Saya Penawaran Terbaik</div>
