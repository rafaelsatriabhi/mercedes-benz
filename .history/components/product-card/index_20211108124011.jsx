...
const ProductCard = ({ car }) => (
  <div className="bg-black hover:bg-white bg-opacity-75 hover:bg-opacity-25 hover:text-black transition ease-in-out duration-500 tablet:w-80 mb-5 tablet:mb-10 border border-gray-200 p-5 rounded-md">
