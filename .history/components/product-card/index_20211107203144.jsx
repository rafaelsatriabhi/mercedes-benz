...
const ProductCard = ({ car }) => (
  <div className="bg-black bg-opacity-75 tablet:w-80 mb-5 tablet:mb-10 border border-gray-200 p-5 rounded-md">
    ...
    <img className="rounded-md" alt={`${car.brand} ${car.name}`} src="/assets/images/mercedes-benz/mercedes-benz-a-200-sedan-a-class-sedan-progressive-line-indonesia.jpg" />
    <div className="">
