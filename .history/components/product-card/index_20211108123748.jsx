...
const ProductCard = ({ car }) => (
  <div className="bg-black hover:bg-white transition ease-in-out duration-200 bg-opacity-75 tablet:w-80 mb-5 tablet:mb-10 border border-gray-200 p-5 rounded-md">
